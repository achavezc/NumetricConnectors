...
MixpanelAPI = (function() {
    ...
    MixpanelAPI.prototype.export_data = function(params, valid_for, cb) {
        ...
        req_opts = {
            ...
            "headers": {
                "Authorization": "Basic " + new Buffer(this.options.api_secret + ":" + '', "utf8").toString("base64")
            }
        };
    ...
    MixpanelAPI.prototype._sign_params = function(params) {
        ...
        if (!(params != null ? params.expire : void 0)) {
            throw new Error('all requests must have expire');
        }
